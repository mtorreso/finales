                    ...
                    buttons: {
                        ...
                        buttons: [

                            {
                                ...
                                title: 'Reporte Departamentos Portal',
                                titleAttr: 'Copiar',
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="NuevoDepartamento.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nuevo</span></a>
                        </div>
                    </div>
                </div>
                <table id="ejemplo" class="table table-striped table-hover">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td><a href="Reservasdeptos?accion=reservas&id=<%= d.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <td>
                                <a href="MostrarInventario?accion=inventario&id=<%= d.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            </td>
                            <td>
                                <a href="verserviciosadmin?accion=servicio&id=<%= d.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            </td>
                            <td>
                                <a href="moddepartamento?accion=modificar&id=<%= d.getId()%>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="Eliminardepto?accion=eliminar&id=<%= d.getId()%>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
                        <%}%>
                    </tbody>
