 ...
 * @author Manuel
 */
public class Solicitudtransporte extends HttpServlet {
    String detalleadmin = "detalleasignacionadmin.jsp";
    String detalle = "detalleasignacioncli.jsp";
    String index = "indexcliete.jsp";
    String acceso = "";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      } else if (accion.equals("detalleadmin")) {
            acceso = detalleadmin;
            request.setAttribute("id_solicitud", request.getParameter("id_solicitud"));
        } else {
            acceso = index;
