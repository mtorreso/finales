 ...
 * @author Manuel
 */
public class nuevoservicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("id_departamento") != null && !request.getParameter("id_departamento").isEmpty()
                    && request.getParameter("nombre_srv") != null && !request.getParameter("nombre_srv").isEmpty()
                    && request.getParameter("precio") != null && !request.getParameter("precio").isEmpty()) {

                request.setAttribute("msg",
                        srv.nuevoservicio(request.getParameter("nombre_srv"),
