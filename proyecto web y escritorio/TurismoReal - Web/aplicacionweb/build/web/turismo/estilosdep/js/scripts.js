(function ($) {
    ...
    req();
    var array = ["18-07-2018", "16-07-2018", "15-07-2018"];
    ...
    function req() {
        ...
        xhttp.open("POST", "getPaid.php");
        xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {


                if (xhttp.responseText == "nada") {
                    DatePicker();
                } else {
                    var rawtext = xhttp.responseText;
                    var truncado = rawtext.substring(0, rawtext.length - 1);
                    var temp = new Array();
                    temp = truncado.split(",");
                    array = temp;
                    // console.log(temp);
            ...
            if (this.status == 403 || this.status == 404) {
                alert("actualmente tenemos problemas con la página de internet y tus solicitudes no se podrán procesar correctamente");
            }
        };
        xhttp.send("dept=" + document.title);
    }
    ...
    function DatePicker() {
        ...
        $(".awe-calendar.from").datepicker({
            ...
            onClose: function (selectedDate) {
                ...
                //  nextDate = (tomorrow.getMonth() + 1) + '/' + tomorrow.getDate() + '/' + selectedDate.getFullYear();
                ...
                if ($("#checkin").val() == "") {
                    ...
                    $("#checkin").css("border-width", "1px");
                } else {
                    $("#checkin").css("border-color", "black");
                    $("#checkin").css("border-width", "0px");
        ...
        $(".awe-calendar.to").datepicker({
            ...
            onClose: function (selectedDate) {
                ...
                if ($("#checkout").val() == "") {
                    ...
                    $("#checkout").css("border-width", "1px");
                } else {
                    $("#checkout").css("border-color", "black");
                    $("#checkout").css("border-width", "0px");
