        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Planificar Transporte</li>
                </ol> 
            </div>

            <div class="col-sm-12">
                <form method="post" action="planificar" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Planificar Transporte Solicitud N° <%=request.getParameter("id_solicitud")%><b></b></h4>
                        </header>

                        <div class="panel-body">
                            <div class="form-group col-lg-2">
                                <label>N° Registro</label>
                                <input id="form_email" type="text" name="id_solicitud" class="form-control" placeholder="id solicitud*"  value="<%=request.getParameter("id_solicitud")%>" readonly="">

                            </div>
                            <div class="form-group col-lg-2">
                                <label>Rut</label>
                                <input id="form_email" type="text" name="rut" class="form-control" placeholder="Ingresar rut solicitante*"  value="<%=request.getParameter("rut")%>" readonly="">

                            </div>
                            <div class="form-group col-lg-6">
                                <label>Nombres</label>
                                <input id="nombres" type="text" name="nombre" class="form-control" placeholder="Ingresar nombre del solicitante*"  value="<%=request.getParameter("nombre")%>" readonly="">

                            </div>
                            <div class="form-group col-lg-5">
                                <label>Origen</label>
                                <input id="origen" type="text" name="origen" class="form-control" placeholder="Ingresar origen*"  value="<%=request.getParameter("origen")%>" readonly="">
                            </div>
                            <div class="form-group">
                                <div class="form-group col-lg-5">
                                    <label>Destino</label>
                                    <input id="destino" type="text" name="destino" class="form-control" placeholder="Ingresar destino*"  value="<%=request.getParameter("destino")%>" readonly="">
                                </div>
                                <div class="form-group col-lg-3">
                                    <label>Fecha</label>
                                    <input id="fecha_solicitud" type="date" name="fecha_solicitud" class="form-control"  required="required" value="<%=request.getParameter("fecha_solicitud")%>" readonly="">                                
                                </div>   
                            </div>
                            <div class="form-group">
                                <div class="form-group col-lg-2">
                                    <label>Hora</label>
                                    <input id="hora_solicitud" type="time" class="form-control" placeholder="Hora solicitud" name="hora_solicitud" value="<%=request.getParameter("hora_solicitud")%>" readonly="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-lg-5">
                                    ...
                                    <input id="conductor" type="text" class="form-control" placeholder="Conductor" name="conductor" value="" required="">

                                </div>  
                                <div class="form-group col-lg-5">
                                    <label>Auto</label>
                                    <input id="auto" type="text" class="form-control" placeholder="auto" name="auto" value="" required="">


                                </div> 
                                <div class="form-group col-lg-5">
                                    <label>Patente</label>
                                    <input id="patente" type="text" class="form-control" placeholder="patente vehiculo" name="patente" value="" required="">

                                    <input id="correo" type="hidden" class="form-control"  name="correo" value="<%=request.getParameter("correo")%>">
                                    <input id="correo" type="hidden" class="form-control"  name="estado" value="1">

                                </div>
                            </div>   
                        </div>
                        <footer class="panel-footer text-right bg-light lter">
                            <input type="submit" class="btn btn-primary active" value="Enviar">&nbsp&nbsp;<button type="reset" class="btn btn-warning">Cancelar</button>
                        </footer>
                    </section> 
