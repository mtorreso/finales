...
<html lang="en">
    <head>
        <title>Turismo Real | Servicios <%=d1.getNombre()%></title>
                    ...
                    buttons: {
                        ...
                        buttons: [

                            {
                                ...
                                title: 'Reporte Servicios <%=d1.getNombre()%> ',
                                titleAttr: 'Copiar',
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Servicios <%=d1.getNombre()%></li>
                </ol> 
            </div>
        </div>
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Servicios <b><%=d1.getNombre()%></b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="servicio?accion=nuevo&id=<%=d1.getId()%>" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nuevo</span></a>
                        </div>
                    </div>
                </div>
                <table id="ejemplo" class="table table-striped table-hover">
                    ...
                    <tbody id="myTable">
                        <%
                            ...
                            List<Serviciosdepto> dato = srv.listarServicios(id);
                            for (Serviciosdepto d : dato) {
                        %>
                        <tr>
                            <td><%= d.getIdSrv()%></td>
                            <td><%= d.getNombreSrv()%></td>
                            <td><%= d.getPrecio()%></td>                          
                            <td>
                                <a href="modservicio?accion=modificar&id=<%= d.getIdSrv()%>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="Eliminarservicio?accion=eliminar&id=<%= d.getIdSrv()%>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
                        <%}%>
                    </tbody>
