            ...
            <div class="tabbable-panel margin-tops4 ">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs tabtop  tabsetting">
                        <li class="active"> <a href="#filtronumeropersonas" data-toggle="tab">Búsqueda por Número de Personas</a> </li>
                    ...
                    <div class="tab-content margin-tops">
                        <div class="tab-pane active fade in" id="filtronumeropersonas">
                            <div class="col-md-4">
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group col-lg-10">
                                                ...
                                                <input id="cantidad_personas" type="number" name="cantidad_personas" class="form-control" placeholder="Ingresar Cantidad Personas *" required="required" value="<%=request.getParameter("cantidad_personas")%>">
                                            </div>
                                ...
                                <table id="ejemplo" class="table table-striped table-hover" style="width:100%">
                                    ...
                                    <tbody id="myTable">
                                        <%
                                            ...
                                            String cantidad_personas = ((String) request.getParameter("cantidad_personas"));
                                            System.out.print("cantidad personas " + cantidad_personas);
                                            ReservasService reser = new ReservasService();
                                            List<Reservas> datos = reser.listarreservaspornumeropersonas(cantidad_personas);
