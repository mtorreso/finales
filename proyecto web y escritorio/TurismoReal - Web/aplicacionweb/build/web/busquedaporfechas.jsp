            ...
            <div class="tabbable-panel margin-tops4 ">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs tabtop  tabsetting">
                        <li class="active"> <a href="#reservasfechas" data-toggle="tab">Reservas por Fechas</a> </li>
                    ...
                    <div class="tab-content margin-tops">
                        <div class="tab-pane active fade in" id="reservasfechas">
                            <div class="col-md-7">
                                ...
                                <table id="ejemplo" class="table table-striped table-hover" style="width:100%">
                                    ...
                                    <tbody id="myTable">
                                        <%
                                            ...
                                            List<Reservas> datos = reser.listarreservasporfechas(fecha_inicio, fecha_final);
