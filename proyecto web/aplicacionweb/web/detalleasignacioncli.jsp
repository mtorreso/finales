<%@page import="webservice.Asignacionestransporte"%>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Detalle Solicitud de Transporte </li>
                </ol> 
            </div>
            <%
                int id_solicitud = Integer.parseInt((String) request.getAttribute("id_solicitud"));
                TransporteService depto = new TransporteService();
                Asignacionestransporte d = depto.detalleasignacion(id_solicitud);
            %>
            <div class="col-sm-12">
                <section class="panel panel-default">
                    <header class="panel-heading blue-dark">
                        <h4>Detalle Solicitud de Transporte  N° <b> <%= d.getIdSolicitud()%></b></h4>
                    </header>
                    <div class="panel-body">
                        <div class="form-group col-lg-3">
                            <label>Fecha</label>
                            <input id="form_email" type="date" name="fecha_solicitud" class="form-control" value="<%= d.getFechaReserva()%>" readonly="">

                        </div>
                        <div class="form-group col-lg-2">
                            <label>Hora</label>
                            <input id="form_email" type="time" name="hora_solicitud" class="form-control" placeholder="Ingresar hora solicitud*" required="required" value="<%= d.getHoraSolicitud()%>" readonly="" >

                        </div>
                        <div class="form-group col-lg-3">
                            <label>Origen</label>
                            <input id="form_email" type="text" name="origen" class="form-control" placeholder="Ingresar origen *" required="required" value="<%= d.getOrigen()%>" readonly="">

                        </div>
                        <div class="form-group col-lg-4">
                            <label>Destino</label>
                            <input id="form_email" type="text" name="destino" class="form-control" placeholder="Ingresar destino*" required="required" value="<%= d.getDestino()%>" readonly="">

                        </div>
                        <div class="form-group col-lg-4">
                            <label>Conductor</label>
                            <input id="form_email" type="text" name="conductor" class="form-control" placeholder="Ingresar conductor*" required="required" value="<%= d.getConductor()%>" readonly="">

                        </div>
                        <div class="form-group col-lg-4">
                            <label>Auto</label>
                            <input id="form_email" type="text" name="auto" class="form-control" placeholder="Ingresar otro auto*" required="required" value="<%= d.getConductor()%>" readonly="">

                        </div>
                        
                        <div class="form-group col-lg-4">
                            <label>Patente</label>
                            <input id="form_email" type="text" name="patente" class="form-control" placeholder="Ingresar parte*" required="required" value="<%= d.getPatente()%>" readonly="">

                        </div>
                        <input id="form_email" type="hidden" name="correo" class="form-control" value="<%
                            //preguntamo por la variable de sesion creada en el servlet
                            if (sesion.getAttribute("email") != null) {
                                out.print(sesion.getAttribute("email"));
                            }
                               %>">
                        <input id="form_email" type="hidden" name="id_reserva" class="form-control" value="<%= d.getIdReserva()%>">
                        <input id="form_email" type="hidden" name="rut" class="form-control" value="<%
                            //preguntamo por la variable de sesion creada en el servlet
                            if (sesion.getAttribute("rut") != null) {
                                out.print(sesion.getAttribute("rut"));
                            }
