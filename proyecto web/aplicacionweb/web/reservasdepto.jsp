                    ...
                    buttons: {
                        ...
                        buttons: [

                            {
                                ...
                                title: 'Reporte Reservas  <%=d1.getNombre()%>',
                                titleAttr: 'Copiar',
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td><%
                                ...
                                out.println("<a href='recibirpago?accion=recibir&id_reserva=" + d.getIdReserva() + "&id=" + d.getId() + "&rut=" + d.getRut() + "' class='btn btn-primary active btn-xs' role='button' onclick='return confirm(\"Seguro que desea ingresar pago de la reserva " + d.getIdReserva() + " de " + d.getNombre() + " ?\")'>Recibir Pago</a>");
                                out.print("</span>");
                                %></td>
                            <td><%= d.getRut()%></td>
                            <td><%= d.getNombre()%></td>
