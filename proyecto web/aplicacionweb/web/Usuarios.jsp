        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Administrador <b>Usuarios</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="Crear_user.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nuevo</span></a>
                        </div>
                    </div>
                </div>
                <table id="ejemplo" class="table table-striped table-hover">
                    ...
                    <tbody id="myTable">
                        <%
                            ...
                            List<Usuario> dato = users.listarusuarios();
                            for (Usuario u : dato) {
                        %>
                        <tr>
