                    ...
                    <table id="example" class="table table-striped table-hover">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td><%= d.getPrecio()%></td>                          
                                <td>
                                    <a href="contratarservicio?accion=contratar&id_srv=<%= d.getIdSrv()%>&id_reserva=<%=request.getParameter("id_reserva")%>&id=<%=request.getParameter("id")%>&correo= <%
                                        //preguntamo por la variable de sesion creada en el servlet
                            ...
                            <%}%>
                        <input id="form_name" type="hidden" name="fecha" class="form-control"  data-error="fecha es requerida." value="" >
