...
<%@page import="Modelo.TransporteService"%>
<!DOCTYPE html>
<%
...
<html lang="en">
    <head>
        <title>Turismo Real | Solicitudes de Transporte <%
            //preguntamo por la variable de sesion creada en el servlet
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active"> Mis Solicitudes de Transporte <%
                        //preguntamo por la variable de sesion creada en el servlet
                        if (sesion.getAttribute("nombre") != null) {
                            out.print(sesion.getAttribute("nombre"));
                        }
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2> Mis Solicitudes de Transporte<b></b></h2>
                        </div>
                        <div class="col-sm-7">
                            <a href="SrvTransporte?accion=nuevasolicitud&id_reserva=<%=request.getAttribute("id_reserva")%>" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nueva Solicitud</span></a>
                ...
                <table id="ejemplo" class="display" style="width:100%">
                    ...
                    <tbody id="myTable">
                        <%
                            ...
                            String id_reserva = ((String) request.getParameter("id_reserva"));
                            System.out.print("id_recerva " + id_reserva);
                            TransporteService trs = new TransporteService();
                            List<Solicitudtransporte> dato = trs.listarmissolicitudes(id_reserva);
                            for (Solicitudtransporte d : dato) {
                        %>
                        <tr>
                            <td><%= d.getIdSolicitud()%></td>
                            <td><%= d.getFechaSolicitud()%></td>
                            <td><%= d.getHoraSolicitud()%></td>
                            <td><%=d.getOrigen()%></td>
                            <td><%= d.getDestino()%></td>
                            <td><%
