        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Registro Servicios <%=d.getNombre()%></li>
                </ol> 
            </div>
            <div class="col-sm-5">
                <form method="post" action="nuevoservicio" role="form">
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-10">
                                <label>Nombre</label>
                                <input id="nombre_srv" type="text" name="nombre_srv" class="form-control" required="required" placeholder="nombre del servicio" value="" >                    
                            </div>
                            <div class="form-group col-lg-4">
                                <label>Precio</label>
                                <input id="precio" type="number" name="precio" class="form-control" required="required" plaholder="Costo" value="" >                                
                            </div>
                            <div class="form-group">


                                <input type="hidden" class="form-control" name="id_departamento" id="id_departamento" value="<%= request.getParameter("id")%>">
                            </div>
                    ...
                    <table id="example" class="table table-striped table-hover">
                        ...
                        <tbody id="myTable">
                            <%
                                ...
                                List<Serviciosdepto> serv = srv.listarServicios(codigo);
                                for (Serviciosdepto ser : serv) {
                            %>
                            <tr>
                                <td><%= ser.getIdSrv()%></td>
