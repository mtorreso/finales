...
<%
    ...
    Serviciosdepto Se = srv.buscarServicio(id);
%>
<html lang="en" class="app">
    <head>
        <meta charset="utf-8" />
        <title>Turismo Real | Servicio <%=Se.getNombreSrv()%> </title>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Actualizar Datos de <%=Se.getNombreSrv()%> de la lista de Servicios</li>
                </ol> 
            </div>
            <div class="col-sm-12">
                <form method="post" action="Modificaservicio" role="form">
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-2">
                                ...
                                <input id="id" type="text" name="id" class="form-control" required="required" placeholder="id del servicio" value="<%=Se.getIdSrv()%>" readonly="" >                    
                            </div>
                            <div class="form-group col-lg-7">
                                <label>Nombre</label>
                                <input id="nombre_srv" type="text" name="nombre_srv" class="form-control" required="required" placeholder="nombre del servicio" value="<%=Se.getNombreSrv()%>" >                    
                            </div>
                            <div class="form-group col-lg-3">
                                <label>Precio</label>
                                <input id="precio" type="number" name="precio" class="form-control" required="required" plaholder="Costo" value="<%=Se.getPrecio()%>" >                                
                            </div>
