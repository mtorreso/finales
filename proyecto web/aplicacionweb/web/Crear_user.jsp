        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Crear Cuentas</li>
                </ol> 
            </div>
            <div class="col-sm-5">
                <form method="post" action="CrearUser" role="form">
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            %>
                            <input id="nombre" type="hidden" name="id_usuario" class="form-control" placeholder="Ingresar nombre*" value="<%=n%>">
                            ...
                            <div class="form-group col-lg-8">
                                <label>Nombres</label>
                                <input id="nombre" type="text" name="nombre" class="form-control" placeholder="Ingresar nombre*" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-group col-lg-7">
                                    ...
                                    <input id="clave" type="password" name="clave" class="form-control" placeholder="Ingresar clave de seguridad*" required="required">
                                </div>
                                <div class="form-group col-lg-5">
                                    <label>Tipo de Usuario</label>
                                    <select class="form-control" id="id_rol" name="id_rol" required="required">
            ...
            <div class="col-sm-7">
                <div class="table-wrapper">
                    ...
                    <table id="example" class="table table-striped table-hover">
                        ...
                        <tbody id="myTable">
                            <%
                                CuentasService users = new CuentasService();
                                List<Usuario> dato = users.listarcuentas();
                                for (Usuario u : dato) {
                            %>
                            <tr>
