                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody id="myTable">
                        <%
                            ...
                            List<Reservas> dato = reser.listarReservas(rut);
                            for (Reservas d : dato) {
                        %>
                        <tr>
                            ...
                            <td>
                                <a href='SrvMisReservas?accion=servicios&id_reserva=<%= d.getIdReserva()%>&id=<%= d.getIdDepartamento()%>'class='btn btn-success btn-xs' role='button'>Listar<span class='glyphicon glyphicon-bell'></span></a>
                                <a href='SrvTransporte?accion=solicitar&id_reserva=<%= d.getIdReserva()%>' class='btn btn-success btn-xs' role='button'>Solicitar Transporte <span class='glyphicon glyphicon-plane'></span></a>
                            </td>
                            <td>
