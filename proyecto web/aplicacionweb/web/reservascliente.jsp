...
<html lang="en">
    <head>
        <%
            String cedula = ((String) request.getParameter("rut"));
            CuentasService user = new CuentasService();
            Usuario d1 = user.mostrarporrut(cedula);
        %>
        <title>Turismo Real | Reporte de Reservas <%=d1.getNombre()%></title>
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2> Reservas  :  <%=d1.getNombre()%><b></b></h2>
                        </div>
                        <div class="col-sm-7">
                        </div>
                    </div>
