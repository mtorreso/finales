                        ...
                        <div class="row row1 scroll-pane">
                            ...
                            <table  class="table table-bordered responsive" id="dataTable">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        <td><a href='Servcomunas?accion=comunas&ubicacion=<%= l.getNombreLocalidad()%>'><%= l.getNombreLocalidad()%></a></td>
                                    </tr>
                                    <%}%>
                                        ...
                                        <div class="col-lg-6">
                                            <%
                                                if (d.getHabilitado().equals("0")) {
                                                    ...
                                                    out.print("<span class=''>");
                                                    out.println("<a href='Servdepto?accion=detalle&id=" + d.getId()+ "' class='btn btn-info active btn-block btn-sm' role='button' onclick='return confirm(\"Seguro que desea ver información para iniciar el proceso de Reserva?\")'>Detalles</a>");
                                                    out.print("</span>");
                                                }
