                    ...
                    buttons: {
                        ...
                        buttons: [

                            {
                                ...
                                title: 'Reporte Solicitudes de Transporte',
                                titleAttr: 'Copiar',
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Solicitudes de Transporte</li>
                </ol> 
            </div>
        </div>
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Solicitudes de  <b>Transporte</b></h2>
                        </div>
                        <div class="col-sm-6">
                ...
                <table id="ejemplo" class="table table-striped table-hover">
                    ...
                    <tbody id="myTable">
                        <%
                            ...
                            List<Solicitudes> dato = ts.listarsolicitudes();
                            for (Solicitudes t : dato) {
                        %>
                        <tr>
                            <td><%
                                ...
                                %></td>
                            <td><%= t.getIdSolicitud()%></td>
                            <td><%= t.getRut()%></td>
                            <td><%= t.getNombre()%></td>
                            <td><%= t.getOrigen()%></td>
                            <td><%= t.getDestino()%></td>
                            <td><%= t.getFechaSolicitud()%>/<%= t.getHoraSolicitud()%></td>
                            <td>
                               <%
                                if (t.getEstado().equals("0")) {
                                    out.print("<span class=''>");
                                    out.println("<a href='planificartransporte.jsp?id_solicitud=" + t.getIdSolicitud()+ "&rut=" + t.getRut()+"&nombre=" + t.getNombre()+"&origen="+t.getOrigen()+"&destino=" + t.getDestino()+"&fecha_solicitud=" + t.getFechaSolicitud()+"&hora_solicitud=" + t.getHoraSolicitud()+"&correo=" + t.getCorreo()+"' class='btn btn-primary active' role='button' onclick='return confirm(\"Seguro que desea asignar transporte a la solicitud seleccionada ?\")'>Planificar</a>");
                                    out.print("</span>");
                                } else if (t.getEstado().equals("1")) {
                                    out.print("<span class=''>");
