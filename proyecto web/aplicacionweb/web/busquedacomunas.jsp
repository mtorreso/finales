...
<%
    ...
    if ((sesion.getAttribute("logeado") == null
        ...
        out.print("<script>alert('Para entrar a esta página debes estar logueado como Cliente'); window.history.back(-1);</script>");
        ...
        <div class="container">
            <div class="col-l12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Departamentos <%=request.getParameter("ubicacion")%></li>
                </ol> 
            </div>
        </div>
        <div class="main">
            <div class="container">
                ...
                <div class="row">
                    <%
                        ...
                        List<Departamento> datos = depto.listarDeptos(ubicacion);
                                        ...
                                        <div class="col-lg-6">
                                            <%
                                                if (d.getHabilitado().equals("0")) {
                                                    ...
                                                    out.println("<a href='' class='btn btn-info active btn-block btn-sm' role='button' onclick='return confirm(\"Departamento No Disponible para Reservar\")'>Detalles</a>");
                                                    out.print("</span>");
                                                } else if (d.getHabilitado().equals("1")) {
                                                    out.print("<span class=''>");
                                                    out.println("<a href='Servdeptocliente?accion=detalle&id=" + d.getId()+ "' class='btn btn-info active btn-block btn-sm' role='button' onclick='return confirm(\"Seguro que desea ver información para iniciar el proceso de Reserva?\")'>Detalles</a>");
                                                    out.print("</span>");
                                                }
