                    ...
                    buttons: {
                        ...
                        buttons: [

                            {
                                ...
                                title: 'Planificación de Transporte  desde <%=request.getParameter("fecha_inicio")%> hasta <%=request.getParameter("fecha_final")%>',
                                titleAttr: 'Copiar',
            ...
            <div class="tabbable-panel margin-tops4 ">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs tabtop  tabsetting">
                        <li class="active"> <a href="#transporte" data-toggle="tab" class="thbada">Planificación Transporte </a> </li>
                        ...
                        <li> <a href="#filtrocomunal" data-toggle="tab">Filtro Comunal</a> </li>
                    </ul>
                    <div class="tab-content margin-tops">
                        <div class="tab-pane active fade in" id="transporte">
                            <div class="col-md-7">
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group col-lg-5">
                                                ...
                                                <input id="fecha_inicio" type="date" name="fecha_inicio" class="form-control" placeholder="Ingresar fecha inicial *" required="required" value="<%=request.getParameter("fecha_inicio")%>">
                                            </div>
                                            <div class="form-group col-lg-5">
                                                <label>Fecha Final</label>
                                                <input id="fecha_final" type="date" name="fecha_final" class="form-control" placeholder="Ingresar fecha final *" required="required" value="<%=request.getParameter("fecha_final")%>">
                                            </div>
                                        </div>
                                ...
                                <table id="ejemplo" class="table table-striped table-hover" style="width:100%">
                                    ...
                                    <tbody id="myTable">
                                        <%
                                            ...
                                            System.out.print("fecha final " + fecha_final);
                                            TransporteService ts = new TransporteService();
                                            List<Solicitudes> datos = ts.listarsolicitudesporfechas(fecha_inicio, fecha_final);
                                            for (Solicitudes d : datos) {
                                        %>
                                        <tr>
                                             <td><%
                                                if (d.getEstado().equals("0")) {
                                                    out.print("<span class='btn btn-warning active'>");
                                                    out.println("Sin Asignar");
                                                    out.print("</span>");
                                            ...
                                            <td><%= d.getIdSolicitud()%></td>
                                            <td><%= d.getRut()%></td>
                                            <td><%= d.getNombre()%></td>
                                            <td><%= d.getFechaSolicitud()%><%=d.getHoraSolicitud()%></td>
                                            <td><%= d.getOrigen()%></td>
                                            <td><%= d.getDestino()%></td>
                        ...
                        <div class="tab-pane fade" id="filtrocomunal">
                            <div class="col-md-7">
