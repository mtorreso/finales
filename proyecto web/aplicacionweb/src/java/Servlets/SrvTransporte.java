 ...
 * @author Manuel
 */
public class SrvTransporte extends HttpServlet {

    String solicitar = "missolicitudestransporte.jsp";
  //  String detalle = "prueba.jsp";
    String nuevasolicitud = "crearsolicitud.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        } else if (accion.equals("nuevasolicitud")) {
            acceso = nuevasolicitud;
            request.setAttribute("id_reserva", request.getParameter("id_reserva"));
        } else {
            acceso = index;
        }
