...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <div class="col-sm-12">
                <form method="post" action="CambiarEstado" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Actualizar Estado :<b> <%= d.getNombre()%></b></h4>
                        </header>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input id="form_email" type="text" name="actual" class="form-control" placeholder="Ingresar nombre del departamento*" required="required" value="
                                       <%
                            ...
                            <div class="form-group col-lg-5">
                                ...
                                <select class="form-control selectric" name="habilitado" required="">
                                    <option value=""></option>
