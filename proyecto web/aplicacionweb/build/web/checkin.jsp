        ...
        <div class="col-sm-3 col-md-2">
            <div class="btn-group">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    Check-in Reserva N° <%=r.getIdReserva()%>
                </button>
        ...
        <div class="col-sm-9 col-md-10">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a href="#transporte" data-toggle="tab"><span class="glyphicon glyphicon-bullhorn"></span>
                        Transporte</a></li>
                <li><a href="#acta" data-toggle="tab"><span class="glyphicon glyphicon-certificate"></span>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in" id="acta">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="form-group col-lg-10">
                                        <label>Fecha</label>
                                        <input type="text" class="form-control" name="fecha" id="fecha" value="  <%=re.getFechaCheckin()%>" readonly="">
