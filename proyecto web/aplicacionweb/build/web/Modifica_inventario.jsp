<%@page import="webservice.Inventario"%>
...
<%
    ...
    Inventario d = inv.detalleinventario(id);
%>
<html lang="en" class="app">
    <head>
        <meta charset="utf-8" />
        <title>Turismo Real | Detalle Producto <%=d.getProducto()%> </title>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Actualizar  <%=d.getProducto()%> del Inventario</li>
                </ol> 
            </div>
            <div class="col-sm-12">
                <form method="post" action="Modificainventario" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Actualizar Producto del Inventario</h4>
                        </header>
                        <div class="panel-body">
                            <div class="form-group col-lg-2">
                                <label>Id Registro</label>
                                <input id="id" type="text" name="id" class="form-control" required="required" data-error="id producto" value="<%= d.getIdInv()%>" readonly="" >                    
                            </div>
                            <div class="form-group col-lg-8">
                                <label>Nombre</label>
                                <input id="form_name" type="text" name="producto" class="form-control" required="required" data-error="nombre de producto" value="<%= d.getProducto()%>" >                    
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group col-lg-2">
                                    ...
                                    <input id="form_name" type="number" name="cantidad" class="form-control" required="required" data-error="Cantidad" value="<%= d.getCantidad()%>" >                                
                                </div>
                                <div class="form-group col-lg-2">
                                    <label>Estado</label>
                                    <select class="form-control selectric" name="estado">
                                        <option value="<%= d.getEstado()%>"><%= d.getEstado()%></option>
                            ...
                            <div class="form-group">
                                <div class="form-group col-lg-10">
                                    ...
                                    <textarea id="form_message" name="descripcion" class="form-control" placeholder="Descripción producto*" rows="4" required="required" data-error="send a message.">
                                        <%= d.getDescripcion()%>
                                    </textarea>
                                </div>
