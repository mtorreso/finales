                ...
                <form method="post" action="ingresarpago" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Ingresar Pago Reserva N° <%=request.getParameter("id_reserva")%><b></b></h4>
                        </header>

                        <div class="panel-body">
                            <div class="form-group col-lg-2">
                                <label>N° Reserva</label>
                                <input id="id_reserva" type="text" name="id_reserva" class="form-control" placeholder="id reserva*"  value="<%=request.getParameter("id_reserva")%>" readonly="">

                            </div>
                            <div class="form-group col-lg-3">
                                <label>Fecha Pago</label>
                                <input id="fechapago" type="date" name="fechapago" class="form-control" placeholder="Ingresar fecha pagoe*"  value="" required="">

                            </div>
                            <div class="form-group col-lg-5">
                                <label>Banco</label>
                                <input id="banco" type="text" name="banco" class="form-control" placeholder="Ingresar nombre banco*"  value="" required="">

                            </div>
                            <div class="form-group col-lg-3">
                                <label>Cuenta</label>
                                <input id="cuenta" type="text" name="cuenta" class="form-control" placeholder="Ingresar número de cuenta*"  value="" required="">
                            </div>
                            <div class="form-group">
                                <div class="form-group col-lg-2">
                                    <label>Monto</label>
                                    <input id="monto" type="text" name="monto" class="form-control" placeholder="Ingresar monto*"  value="" required="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input id="correo" type="hidden" class="form-control"  name="correo" value="<%=u.getCorreo()%>">
