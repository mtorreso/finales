        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Gestor Departamentos</li>
                </ol> 
            </div>
            <%
            ...
            %>
            <div class="col-sm-12">
                <form method="post" action="Modificadepartamento" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Actualizar Datos :<b> <%= d.getNombre()%></b></h4>
                        </header>

                        <div class="panel-body">
                            <div class="form-group col-lg-2">
                                <label>N° Registro</label>
                                <input id="form_email" type="text" name="id" class="form-control" placeholder="Ingresar id del departamento*" required="required" value="<%= d.getId()%>" readonly="">

                            </div>
                            <div class="form-group col-lg-3">
                                <label>Fecha Publicación</label>
                                <input id="form_email" type="date" name="fecha" class="form-control" placeholder="Ingresar fecha publicidad del departamento*" required="required" value="<%= d.getFecha()%>" readonly="">

                            </div>
                            <div class="form-group col-lg-10">
                                <label>Nombres</label>
                                <input id="form_email" type="text" name="nombre" class="form-control" placeholder="Ingresar nombre del departamento*" required="required" value="<%= d.getNombre()%>">

                            </div>
                            <div class="form-group col-lg-5">
                                <label>Comuna/Ciudad</label>
                                <select class="form-control selectric" name="ubicacion">
                                    <option value="<%= d.getUbicacion()%>"><%= d.getUbicacion()%></option>

                                    <%
                                        LocalidadService lo = new LocalidadService();
                                        List<Localidad> dato = lo.listarLocalidades();
                                        for (Localidad local : dato) {
                                    %>
                                    <option value="<%= local.getNombreLocalidad()%>"><%= local.getNombreLocalidad()%></option>  
                                    <%}%>
                                </select>
                            ...
                            <div class="form-group">
                                <div class="form-group col-lg-5">
                                    ...
                                    <input id="form_name" type="text" name="direccion" class="form-control" required="required" data-error="Dirección es requerida." value="<%= d.getDireccion()%>" >
                                </div>
                                <div class="form-group col-lg-3">
                                    <label>Baños</label>
                                    <input id="form_email" type="number" name="banos" class="form-control" placeholder="Número Baños*" required="required" value="<%= d.getBanos()%>">                                
                                </div>   
                            </div>
                            <div class="form-group">
                                <div class="form-group col-lg-3">
                                    <label>Dormitorios</label>
                                    <input id="habitaciones" type="number" class="form-control" placeholder="Nª Dormitorios*" name="habitaciones" value="<%= d.getHabitaciones()%>" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Valor Arriendo</label>
                                    <input type="number" class="form-control" name="valorarriendo" id="valorarriendo" value="<%= d.getValorarriendo()%>" >
                                </div>   
                            </div>
                            <div class="form-group">
                                <div class="form-group col-lg-10">
                                    <label>Descripciòn Aviso</label>
                                    <textarea id="form_message" name="descripcion" class="form-control" placeholder="Descripción aviso de arriendo*" rows="4" required="required" data-error="send a message.">
                                        <%= d.getDescripcion()%>
                                    </textarea>
                                </div>   
                            </div>   
