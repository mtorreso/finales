        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Nueva Solicitud de Transporte</li>
                </ol> 
            </div>
            <%
                int id_reserva = Integer.parseInt((String) request.getAttribute("id_reserva"));
                ReservasService depto = new ReservasService();
                Reserva d = depto.idReserva(id_reserva);
            %>
            <div class="col-sm-12">
                <form method="post" action="nuevasolicitud" role="form">
                    <section class="panel panel-default">
                        <header class="panel-heading blue-dark">
                            <h4>Nueva Solicitud de Transporte Reserva N° <b> <%= d.getIdReserva()%></b></h4>
                        </header>
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                <label>Fecha</label>
                                <input id="form_email" type="date" name="fecha_solicitud" class="form-control" placeholder="Ingresar fecha solicitud*" required="required" value="">

                            </div>
                            <div class="form-group col-lg-2">
                                <label>Hora</label>
                                <input id="form_email" type="time" name="hora_solicitud" class="form-control" placeholder="Ingresar hora solicitud*" required="required" value="" >

                            </div>
                            <div class="form-group col-lg-3">
                                <label>Origen</label>
                                <input id="form_email" type="text" name="origen" class="form-control" placeholder="Ingresar origen *" required="required" value="">

                            </div>
                            <div class="form-group col-lg-4">
                                <label>Destino</label>
                                <input id="form_email" type="text" name="destino" class="form-control" placeholder="Ingresar destino*" required="required" value="">
